...
class User(UserMixin):
    def __init__(self, username, email, has_access, is_admin, is_authenticated=False):
...
def load_user(login):
    ...
    if user_info is None:
        ...
        return User(user_info["username"], user_info["email"], user_info["has_access"], user_info["is_admin"])
